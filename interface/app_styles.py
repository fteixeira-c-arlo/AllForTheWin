...
Qt Style Sheets are NOT full CSS. Unsupported / unreliable in QSS includes:
...
def install_stylesheet_debug() -> None:
    ...
    Enable by setting env ``ARLO_SHELL_DEBUG_STYLESHEET`` to 1/true/yes before launch.
    """
...
def qcombobox_dark_stylesheet(
    *,
    ...
    return (
        ...
        f"padding: {padding}; min-height: {mh}px; font-size: {font_size}; }}"
        f"QComboBox::drop-down {{ border: none; width: {dw}px; }}"
